	...
	public class Loader : Node, Model.NodeDataImporter {
        ...
        private class IgnorePattern
        {
            ...
            public bool IsMatch(string path) {
                ...
                if (m_match == null) {
                    m_match = new Regex(m_ignorePattern, RegexOptions.Compiled);
                }
			...
			PerformGraph.Output Output) 
		{
            ...
            //Array.Sort(targetFiles,new CaseInsensitiveComparer());
            var targetFiles = Directory.GetFiles(loadPath, "*.*", SearchOption.AllDirectories);
