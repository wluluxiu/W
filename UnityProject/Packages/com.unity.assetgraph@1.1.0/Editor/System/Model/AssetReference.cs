...
namespace UnityEngine.AssetGraph {
	...
	public class AssetReference {
        ...
        public long GetTextureSize()
        {
	        ...
	        var importer = AssetImporter.GetAtPath(m_importFrom) as TextureImporter;
	        GetTextureOriginalSize(importer, out var w,out var h);
	        w = Mathf.Min(importer.maxTextureSize, w);
	        h = Mathf.Min(importer.maxTextureSize, h);
