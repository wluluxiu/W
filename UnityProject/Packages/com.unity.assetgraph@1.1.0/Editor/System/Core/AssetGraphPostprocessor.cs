...
namespace UnityEngine.AssetGraph {
	...
	class AssetGraphPostprocessor : AssetPostprocessor 
	{
        ...
        private List<string> m_ModifiedImportSettings;
        ...
        private void Init() {
            ...
            m_ModifiedImportSettings = new List<string>();
        ...
        public void AddModifiedImportSetting(AssetReference a)
        {
            if (!m_ModifiedImportSettings.Contains(a.importFrom))
            {
                m_ModifiedImportSettings.Add(a.importFrom);
            }
        }

        public bool HasModifiedByOtherGraph(AssetReference a)
        {
            return m_ModifiedImportSettings.Contains(a.importFrom);
        }
            ...
            string[] deletedAssets, string[] movedAssets, string[] movedFromAssetPaths) 
        {
            ...
            m_ModifiedImportSettings.Clear();
