...
namespace jj.TATools.Editor
{
    ...
    /// Resources 目录资源详情报告
    /// </summary>
    internal class AssetInResourcesFolderReporter
    {
        internal static void GenerateReport(ExcelPackage package)
        {
            ...
            ExcelWorksheet inResourcesFolderWS = package.Workbook.Worksheets.Add(ConstDefine.REPORT_ASSETCOMPARE_SHEET_17);
            ...
            inResourcesFolderWS.Column(6).Width = 14;
            inResourcesFolderWS.Column(7).Width = 18;
            inResourcesFolderWS.Column(8).Width = 14;
            inResourcesFolderWS.Column(9).Width = 14;
            inResourcesFolderWS.Column(10).Width = 14;
            inResourcesFolderWS.Column(11).Width = 14;
            inResourcesFolderWS.Column(12).Width = 14;
            inResourcesFolderWS.Column(13).Width = 14;
            inResourcesFolderWS.Column(14).Width = 14;
            inResourcesFolderWS.Column(15).Width = 14;
            inResourcesFolderWS.Column(16).Width = 14;
            inResourcesFolderWS.Column(17).Width = 14;
            inResourcesFolderWS.Column(18).Width = 14;
            inResourcesFolderWS.Column(19).Width = 14;
            inResourcesFolderWS.Column(20).Width = 14;
            inResourcesFolderWS.Column(21).Width = 14;
            ...
            ExcelHelper.SetExcelRange(tempExcelRange, ConstDefine.REPORT_REOURCES_FOLDER_ASSET_TITLE, ExcelHorizontalAlignment.Center, ExcelVerticalAlignment.Center, 16, true, true,
                 ExcelBorderStyle.Thin, ExcelBorderStyle.Thin, ExcelBorderStyle.Thin, ExcelBorderStyle.Thin,
            ...
            // 超链接：Resources目录资源统计
            int currentRow = 4;
            var currentFilesSizeData = AssetRecordDataParser.FilesInResourcesFolderSizeMapping;
            ...
            var currentTotalFilesMapping = AssetRecordDataParser.FileInResourcesFolderMapping;
            ...
            foreach (var assetType in allAssetTypeMapping)
            {
                ...
                {
                    currentRow = AssetReportUtils.GenerateCommonTextureReport(inResourcesFolderWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, true);
                }
                else if (assetType == EAssetType.RenderTexture)
                {
                    currentRow = AssetReportUtils.GenerateCommonRenderTextureReport(inResourcesFolderWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, true);
                }
                else if (assetType == EAssetType.SpriteAtlas)
                {
                    currentRow = AssetReportUtils.GenerateCommonSpriteAtlasReport(inResourcesFolderWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, true);
                }
                else if (assetType == EAssetType.Model)
                {
                    currentRow = AssetReportUtils.GenerateCommonModelReport(inResourcesFolderWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, true);
                }
                else if (assetType == EAssetType.Mesh)
                {
                    currentRow = AssetReportUtils.GenerateCommonMeshReport(inResourcesFolderWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, true);
                }
                else if (assetType == EAssetType.Prefab)
                {
                    currentRow = AssetReportUtils.GenerateCommonPrefabReport(inResourcesFolderWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, true);
                }
                else if (assetType == EAssetType.Scene)
                {
                    currentRow = AssetReportUtils.GenerateCommonSceneReport(inResourcesFolderWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, true);
                }
                else if (assetType == EAssetType.Material)
                {
                    currentRow = AssetReportUtils.GenerateCommonMaterialReport(inResourcesFolderWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, true);
                }
                else if (assetType == EAssetType.Shader)
                {
                    currentRow = AssetReportUtils.GenerateCommonShaderReport(inResourcesFolderWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, true);
                }
                else if (assetType == EAssetType.AnimationClip)
                {
                    currentRow = AssetReportUtils.GenerateCommonClipReport(inResourcesFolderWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, true);
                }
                else
                {
                    currentRow = AssetReportUtils.GenerateCommonDefaultReport(inResourcesFolderWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, true);
                }
            ...
            foreach (var assetType in allAssetTypeMapping)
            {
                ...
                ExcelHelper.SetHyperLink(tempExcelRange, ConstDefine.REPORT_ASSETCOMPARE_SHEET_17, hyperLinkToDetailsMapping[assetType], typeShowName);
