...
namespace jj.TATools.Editor
{
    ...
    /// 资源迭代删除详情报告
    /// </summary>
    internal class AssetDeletedReporter
    {
        internal static void GenerateReport(ExcelPackage package)
        {
            ...
            ExcelWorksheet currentDeletedWS = package.Workbook.Worksheets.Add(ConstDefine.REPORT_ASSETCOMPARE_SHEET_3);
            currentDeletedWS.View.ShowGridLines = false;
            currentDeletedWS.Column(1).Width = 5;
            currentDeletedWS.Column(2).Width = 30;
            currentDeletedWS.Column(3).Width = 18;
            currentDeletedWS.Column(4).Width = 18;
            currentDeletedWS.Column(5).Width = 35;
            currentDeletedWS.Column(6).Width = 14;
            currentDeletedWS.Column(7).Width = 18;
            currentDeletedWS.Column(8).Width = 14;
            currentDeletedWS.Column(9).Width = 14;
            currentDeletedWS.Column(10).Width = 14;
            currentDeletedWS.Column(11).Width = 14;
            currentDeletedWS.Column(12).Width = 14;
            currentDeletedWS.Column(13).Width = 14;
            currentDeletedWS.Column(14).Width = 14;
            currentDeletedWS.Column(15).Width = 14;
            currentDeletedWS.Column(16).Width = 14;
            currentDeletedWS.Column(17).Width = 14;
            currentDeletedWS.Column(18).Width = 14;
            currentDeletedWS.Column(19).Width = 14;
            currentDeletedWS.Column(20).Width = 14;
            currentDeletedWS.Column(21).Width = 14;
            ...
            ExcelHelper.SetExcelRange(tempExcelRange, ConstDefine.REPORT_RETURN, ExcelHorizontalAlignment.Center, ExcelVerticalAlignment.Center, 11, true, false,
                 ...
                 RETURN_COLOR);
            tempExcelRange = currentDeletedWS.Cells[1, 2, 1, 4];
            ExcelHelper.SetExcelRange(tempExcelRange, ConstDefine.REPORT_DELETED_TITLE, ExcelHorizontalAlignment.Center, ExcelVerticalAlignment.Center, 16, true, true,
                 ExcelBorderStyle.Thin, ExcelBorderStyle.Thin, ExcelBorderStyle.Thin, ExcelBorderStyle.Thin,
            ...
            // 超链接：当前版本资源删除统计
            int currentRow = 4;
            var currentFilesSizeData = AssetRecordDataParser.CurrentDeletedFilesSizeMapping;
            ...
            var currentTotalFilesMapping = AssetRecordDataParser.CurrentVersionDeletedMapping;
            ...
            foreach (var assetType in allAssetTypeMapping)
            {
                ...
                {
                    currentRow = AssetReportUtils.GenerateCommonTextureReport(currentDeletedWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, false);
                }
                else if (assetType == EAssetType.RenderTexture)
                {
                    currentRow = AssetReportUtils.GenerateCommonRenderTextureReport(currentDeletedWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, false);
                }
                else if (assetType == EAssetType.SpriteAtlas)
                {
                    currentRow = AssetReportUtils.GenerateCommonSpriteAtlasReport(currentDeletedWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, false);
                }
                else if (assetType == EAssetType.Model)
                {
                    currentRow = AssetReportUtils.GenerateCommonModelReport(currentDeletedWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, false);
                }
                else if (assetType == EAssetType.Mesh)
                {
                    currentRow = AssetReportUtils.GenerateCommonMeshReport(currentDeletedWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, false);
                }
                else if (assetType == EAssetType.Prefab)
                {
                    currentRow = AssetReportUtils.GenerateCommonPrefabReport(currentDeletedWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, false);
                }
                else if (assetType == EAssetType.Scene)
                {
                    currentRow = AssetReportUtils.GenerateCommonSceneReport(currentDeletedWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, false);
                }
                else if (assetType == EAssetType.Material)
                {
                    currentRow = AssetReportUtils.GenerateCommonMaterialReport(currentDeletedWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, false);
                }
                else if (assetType == EAssetType.Shader)
                {
                    currentRow = AssetReportUtils.GenerateCommonShaderReport(currentDeletedWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, false);
                }
                else if (assetType == EAssetType.AnimationClip)
                {
                    currentRow = AssetReportUtils.GenerateCommonClipReport(currentDeletedWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, false);
                }
                else
                {
                    currentRow = AssetReportUtils.GenerateCommonDefaultReport(currentDeletedWS, currentRow, typeShowName, assetType, assetDataMapping, hyperLinkToTotalMapping, CONTENT_DATA_COLOR_0, CONTENT_DATA_COLOR_1, SPECIAL_DATA_COLOR_0, currentFilesSizeData, false);
                }
            ...
            foreach (var assetType in allAssetTypeMapping)
            {
                ...
                ExcelHelper.SetHyperLink(tempExcelRange, ConstDefine.REPORT_ASSETCOMPARE_SHEET_3, hyperLinkToDetailsMapping[assetType], typeShowName);
